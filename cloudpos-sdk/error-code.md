...
_**SmartCard Reader\[Old defination]**_
...
| `0x07`     | 7             | Argument list too long                  |
| `0x08`     | 8             | Exec format error                       |
| `0x09`     | 9             | Bad file number                         |
| `0x0A`     | 10            | No child processes                      |
| `0x0B`     | 11            | Try again / Operation would block       |
| `0x0B`     | 11            | Operation would block (same as EAGAIN)  |
| `0x0C`     | 12            | Out of memory                           |
| `0x0D`     | 13            | Permission denied                       |
| `0x0E`     | 14            | Bad address                             |
...
| `0x20`     | 32            | Broken pipe                             |
| `0x21`     | 33            | Math argument out of domain             |
...
| `0x26`     | 38            | Invalid system call number              |
| `0x27`     | 39            | Directory not empty                     |
| `0x28`     | 40            | Too many symbolic links                 |
...
| `0x5D`     | 93            | Protocol not supported                  |
| `0x5F`     | 95            | Operation not supported                 |
